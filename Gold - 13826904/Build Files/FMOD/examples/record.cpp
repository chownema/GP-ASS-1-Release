...
int FMOD_Main()
{
    ...
    */
    ...
    result = system->getRecordNumDrivers(&recordnumdrivers, 0);
    ERRCHECK(result);
    ...
    */
    result = system->getRecordDriverInfo(DEVICE_INDEX, NULL, 0, 0, &recordrate, 0, &recordchannels, 0);
    ERRCHECK(result);
    ...
    */
    do
    {
        ...
        */
        ...
        system->isRecording(DEVICE_INDEX, &isRecording);
        ERRCHECK(result);

        if (isRecording)
        {
            system->getRecordPosition(DEVICE_INDEX, &recordpos);
            ERRCHECK(result);
        }
